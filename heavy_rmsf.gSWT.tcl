...
#last 100ns dcd file
set dcd /DFS-L/DATA/tobias/ddeming/crystallins/gSwt_deamidated/gSWT/analysis/traj/HA_rmsf_gSWT_protein-0-399999-every2.dcd 
set type dcd

set theFileRange [list 0 99999]

set NTsel  "protein and name CA and resid 5 to 90"
set CTsel  "protein and name CA and resid 91 to 174"
...
foreach seg $seglist {
	puts "Processing $seg"
	set opf [open ${outfile}_[lindex heavyatom]_[lindex $theFileRange 1].dat w]
  set allsel [atomselect $molwork "protein and (sidechain and noh)"]
